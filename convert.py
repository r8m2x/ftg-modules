...
class ConvertMod(loader.Module):
    ...
    strings = {
                "name": "convert",
                "no_reply": "<code>Мне нужен реплай на файл.</code>",
                "not_media": "<code>Реплай должен быть на медиа(ну там войс, мп3, мп3)."
              }
    ...
    async def voicecmd(self, message):
        """.voice [реплай] - конвертация в войс"""
